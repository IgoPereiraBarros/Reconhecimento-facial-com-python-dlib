...
for file in glob(os.path.join('../materials/fotos/treinamento', '*.jpg')):
...
np.save('../materials/recursos/descriptors_rn.npy', facial_descriptors)
with open('../materials/recursos/indexes_rn.pickle', 'wb') as f:
